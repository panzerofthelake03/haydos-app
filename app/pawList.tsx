  ...
  return (
    <View style= {styles.container}>
      <View style={styles.header}>
        <TouchableOpacity
          onPress={() => navigation.goBack()} // Updated to use navigation
      ...
      <FlatList
        ...
        numColumns={2}
        renderItem={({ item }) => <PawItem name={item.name} image={item.image} imageDetailed={item.imageDetailed} gender={item.Gender} age={item.Age} whereToFindMe={item.WhereToFindMe} funFact={item.FunFact}/>}
